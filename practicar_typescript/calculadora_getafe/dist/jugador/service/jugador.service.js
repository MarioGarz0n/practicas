...
let JugadorService = class JugadorService extends service_commons_1.BaseService {
    constructor(jugadorRepo) {
        super();
...
exports.JugadorService = JugadorService = __decorate([
    __param(0, (0, typeorm_2.InjectRepository)(jugador_entity_1.Jugador)),
